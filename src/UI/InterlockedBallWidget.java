...
// Виджет сцепляемого шара
public class InterlockedBallWidget extends GameObjectWidget {

    public InterlockedBallWidget(InterlockedBall ib) {
        super(ib);
    }
            ...
            if (go instanceof InterlockedObject) {
                ...
                if (io.isMetal()) {
                    ...
                    if (mp instanceof MagneticProperty) { //магнитный ящик
                        ...
                        g.drawImage(getImageByPath("texture_ball_magnetic.png"), 0, 0, null);
                        ...
                        g.drawImage(getImageByPath("texture_ball_metal.png"), 0, 0, null);
                }
                else //скрепляемый ящик
                    g.drawImage(getImageByPath("texture_ball.png"), 0, 0, null);
            }
            else //ящик
                g.drawImage(getImageByPath("texture_ball.png"), 0, 0, null);
        }
